...
Die Rolle yanic führt Tasks aus, die wie folgt gruppiert sind:
...
Die Rolle yanic nutzt folgende Variablen in *defaults* und / oder *vars*:

Die Rolle yanic nutzt folgende Variablen in vars:
...
Die Rolle yanic nutzt folgende Templates in *templates*:
...
Die Rolle yanic nutzt folgende Dateien in *files*:
...
Die Rolle yanic nutzt folgende Meta-Daten:
