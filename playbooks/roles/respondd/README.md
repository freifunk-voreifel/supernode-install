...
Die Rolle respondd führt Tasks aus, die wie folgt gruppiert sind:
...
Die Rolle respondd nutzt folgende Variablen in *defaults* und / oder *vars*:

Die Rolle respondd nutzt folgende Variablen in vars:
...
Die Rolle respondd nutzt folgende Templates in *templates*:
...
Die Rolle respondd nutzt folgende Dateien in *files*:
...
Die Rolle respondd nutzt folgende Meta-Daten:
