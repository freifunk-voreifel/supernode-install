...
Die Rolle backbone führt Tasks aus, die wie folgt gruppiert sind:
...
Die Rolle backbone nutzt folgende Variablen in *defaults* und / oder *vars*:

Die Rolle backbone nutzt folgende Variablen in vars:
...
Die Rolle backbone nutzt folgende Templates in *templates*:
...
Die Rolle backbone nutzt folgende Dateien in *files*:
...
Die Rolle backbone nutzt folgende Meta-Daten:
