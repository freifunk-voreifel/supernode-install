...
Die Rolle common führt Tasks aus, die wie folgt gruppiert sind:
...
Die Rolle common nutzt folgende Variablen in *defaults* und / oder *vars*:

Die Rolle common nutzt folgende Variablen in vars:
...
Die Rolle common nutzt folgende Templates in *templates*:
...
Die Rolle common nutzt folgende Dateien in *files*:
...
Die Rolle common nutzt folgende Meta-Daten:
