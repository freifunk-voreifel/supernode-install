...
Die Rolle radvd führt Tasks aus, die wie folgt gruppiert sind:
...
Die Rolle radvd nutzt folgende Variablen in *defaults* und / oder *vars*:

Die Rolle radvd nutzt folgende Variablen in vars:
...
Die Rolle radvd nutzt folgende Templates in *templates*:
...
Die Rolle radvd nutzt folgende Dateien in *files*:
...
Die Rolle radvd nutzt folgende Meta-Daten:
