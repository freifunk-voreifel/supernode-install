...
Die Rolle firewall führt Tasks aus, die wie folgt gruppiert sind:
...
Die Rolle firewall nutzt folgende Variablen in *defaults* und / oder *vars*:

Die Rolle firewall nutzt folgende Variablen in vars:
...
Die Rolle firewall nutzt folgende Templates in *templates*:
...
Die Rolle firewall nutzt folgende Dateien in *files*:
...
Die Rolle firewall nutzt folgende Meta-Daten:
