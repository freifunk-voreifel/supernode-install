...
Die Rolle vrf führt Tasks aus, die wie folgt gruppiert sind:
...
Die Rolle vrf nutzt folgende Variablen in *defaults* und / oder *vars*:

Die Rolle vrf nutzt folgende Variablen in vars:
...
Die Rolle vrf nutzt folgende Templates in *templates*:
...
Die Rolle vrf nutzt folgende Dateien in *files*:
...
Die Rolle vrf nutzt folgende Meta-Daten:
