...
Die Rolle bird führt Tasks aus, die wie folgt gruppiert sind:
...
Die Rolle bird nutzt folgende Variablen in *defaults* und / oder *vars*:

Die Rolle bird nutzt folgende Variablen in vars:
...
Die Rolle bird nutzt folgende Templates in *templates*:
...
Die Rolle bird nutzt folgende Dateien in *files*:
...
Die Rolle bird nutzt folgende Meta-Daten:
