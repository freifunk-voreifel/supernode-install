...
Die Rolle letsencrypt führt Tasks aus, die wie folgt gruppiert sind:
...
Die Rolle letsencrypt nutzt folgende Variablen in *defaults* und / oder *vars*:

Die Rolle letsencrypt nutzt folgende Variablen in vars:
...
Die Rolle letsencrypt nutzt folgende Templates in *templates*:
...
Die Rolle letsencrypt nutzt folgende Dateien in *files*:
...
Die Rolle letsencrypt nutzt folgende Meta-Daten:
