...
Die Rolle dnsserver führt Tasks aus, die wie folgt gruppiert sind:
...
Die Rolle dnsserver nutzt folgende Variablen in *defaults* und / oder *vars*:

Die Rolle dnsserver nutzt folgende Variablen in vars:
...
Die Rolle dnsserver nutzt folgende Templates in *templates*:
...
Die Rolle dnsserver nutzt folgende Dateien in *files*:
...
Die Rolle dnsserver nutzt folgende Meta-Daten:
