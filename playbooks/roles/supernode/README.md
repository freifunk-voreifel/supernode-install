...
Die Rolle supernode führt Tasks aus, die wie folgt gruppiert sind:
...
Die Rolle supernode nutzt folgende Variablen in *defaults* und / oder *vars*:

Die Rolle supernode nutzt folgende Variablen in vars:
...
Die Rolle supernode nutzt folgende Templates in *templates*:
...
Die Rolle supernode nutzt folgende Dateien in *files*:
...
Die Rolle supernode nutzt folgende Meta-Daten:
